...
namespace Assignment6
{
    class EmpEvent
    {
        static void Main()
        {
            Employee1 e1 = new Employee1(E1_InvalidEmpName, E1_InvalidEmpBasic, E1_InvalidEmpDepNo, "yashu", 12000, 1);


            Console.WriteLine("Empid: " + e1.EMPNO + ", Name: " + e1.NAME + ", Basic salary: " + e1.BASIC + ", Dept No: " + e1.DEPTNO + ", Net salary: " + e1.GetNetSalary());
            Console.ReadLine();

            Employee1 e2 = new Employee1(E2_InvalidEmpName, E2_InvalidEmpBasic, E2_InvalidEmpDepNo, "sup", 20000, 1);

            Console.WriteLine("Empid: " + e2.EMPNO + ", Name: " + e2.NAME + ", Basic salary: " + e2.BASIC + ", Net salary: " + e2.GetNetSalary());
            Console.ReadLine();

            Employee1 e3 = new Employee1(E3_InvalidEmpName, E3_InvalidEmpBasic, E3_InvalidEmpDepNo, "", 4000);
    ...
    class Employee1
    {
        ...
        {
            if (BASIC >= 20000 && BASIC <= 60000)
            {
                decimal netSal = BASIC + 1500;
                return netSal;
            }
            return BASIC;
